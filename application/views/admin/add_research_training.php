...
<div class="container">
    <div class="row well">
        <h2 style="text-align: center;">Add Research training <span class="glyphicon glyphicon-fire"></span></h2>
        <p>&nbsp;</p>        

        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url(); ?>/admin/add_research_training_process">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        <a href="<?php echo site_url() . '/admin/research_training/' . $researcher_id; ?>">Cancel</a>
                    </div>
                </div>
